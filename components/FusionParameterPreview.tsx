      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          {result.heights && (
            <ParameterSection title="Height Parameters">
              ...
              <ParameterRow
                name="baseHeight"
                value={result.heights.baseHeight}
                unit="mm"
              />
        ...
        <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5">
          ...
          <p className="mt-1 text-sm leading-6 text-neutral-600">
            ...
            generated by the validated Engineering Calculation Engine.
            Tray Storage System heights are also generated by the Engineering
            Calculation Engine from the strategy-dependent tray-height input
            and the centralized V1 box-lid height constant.
          </p>
        </div>
      </div>
    </details>
